...
async def copy_message_with_chat_id(app, userbot, sender, chat_id, message_id, edit):
    ...
    try:
        ...
        # Keep the source Telegram caption/entities exactly as received.
        # .html preserves bold, italic, underline, links, code, spoiler, etc.
        final_caption = msg.caption.html if msg.caption else None
